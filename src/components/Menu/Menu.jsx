...
import { Grid, Paper, Card, CardContent, Typography, SvgIcon, CardActionArea } from '@material-ui/core';
...
function Menu(props) {
    ...
    const menu = pagetest.map((page,key) => (
            ...
            <Grid item md={6} xs={12} >
                <Card className={classes.card}>
                    ...
                    <CardContent className={classes.content}>
                        <div>
                            {/* style={{maxWidth:'500px'}}> */}
                            <Typography component="h5" variant="h5" style={{ color: '#7FBBE2' }} align="left" >
                                Heading
                </Typography>
